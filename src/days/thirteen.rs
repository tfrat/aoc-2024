...
impl DayThirteen {
    fn parse_machines(input: &str) -> Vec<PrizeMachine> {
        /*
        Button A: X+94, Y+34
        Button B: X+22, Y+67
        Prize: X=8400, Y=5400
    ...
    fn get_prizes(machines: &[PrizeMachine]) -> u32 {
        machines
            .iter()
...
impl Day for DayThirteen {
    fn part_one(&self, input: &str) -> String {
        let machines = DayThirteen::parse_machines(input);
